...
#Modelo 1: Se utiliza un modelo con topología de 3 capas con 10 neuronas en cada una y una función lineal de activación
mplC = MLPClassifier(random_state=123, hidden_layer_sizes = (5, 5), activation = 'identity', max_iter=10000)
start = timeit.default_timer()
mplC.fit(X_train,y_train)
end = timeit.default_timer()
print('Tiempo de Fit para el modelo con topología de 2 capas con 5 neuronas en cada una y una función lineal de activación: ',  end-start)

y_predf = mplC.predict(X_train)
start = timeit.default_timer()
y_pred = mplC.predict(X_test)
end = timeit.default_timer()
print('Tiempo de predict del modelo con topología de 2 capas con 5 neuronas en cada una y una función lineal de activación: ',  end-start)
cm = confusion_matrix(y_test,y_pred)
print ("Accuracy entrenamiento para el modelo con topología de 2 capas con 5 neuronas en cada una y una función lineal de activación:",metrics.accuracy_score(y_train, y_predf))
print ("Accuracy para el modelo con topología de de 2 capas con 5 neuronas en cada una y una función lineal de activación:",metrics.accuracy_score(y_test, y_pred))
